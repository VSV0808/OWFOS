    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">OWFOS</a>
        </div>
...
?>
    ...
    <div class="wide">
        ...
        <div class="tagline">It's not just a <font color="red"><strong>web page</strong></font>, it's our <font color="green"><strong><em>ideas into outputs</em>.</strong></font></div>
        <h3 style="color: red">OWFOS was an idea we had been developing for sometime now</h3>
        <br>
